package com.ardovic.funcontrol;
...
public class FanControl extends View {
    ...
    public FanControl(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public FanControl(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mFanOnColor = typedArray.getColor(R.styleable.FanControl_fanOnColor, mFanOnColor);
            mFanOffColor = typedArray.getColor(R.styleable.FanControl_fanOffColor, mFanOffColor);
